...
| Stream quality settings | Implemented, with display capabilities, explicit HDR request control, AI prefilter entitlement/mode gating, and cloud-variable request gating | `src/streaming/OPNStreamPreferences.*`, `src/streaming/OPNSessionManager.mm`, `src/views/OPNSettingsView.mm` |
